"""
Django settings for cityflow_backend project.
...
SECRET_KEY = 'django-insecure-arlwvch+zr4hpe==mj&i9ey!ah#u%-*o7zt0#u0)=t_urmtad3'
...
# CORS — restreindre aux origines réelles en production
CORS_ALLOW_ALL_ORIGINS = True  # dev only

# Logging — INFO sur les apps du projet, WARNING sur le reste
LOGGING = {
    'version': 1,
